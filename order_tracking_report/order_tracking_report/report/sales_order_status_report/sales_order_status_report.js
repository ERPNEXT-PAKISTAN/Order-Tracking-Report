frappe.query_reports["Sales Order Status Report"] = {
  ...
  filters: [
    {
      ...
      label: __("Group By"),
      fieldtype: "Select",
      options: ["Sales Order Number", "Customer", "Item Group", "Item"],
    ...
    },
    {
      ...
      label: __("Status"),
      fieldtype: "Select",
      options: ["", "Draft", "To Deliver and Bill", "To Bill", "To Deliver", "Completed", "Closed", "Cancelled"],
    },
    {
  ...
  formatter: function (value, row, column, data, default_formatter) {
    ...
    if (["qty", "delivered_qty", "pending_qty"].includes(column.fieldname)) {
